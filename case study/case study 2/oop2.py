...
if __name__=="__main__":
    asst1=lab_asst("Ram",date(1995,12,6),"Computer","e001",50000,["b1","b2"])
    asst2=lab_asst("Shyam",date(1997,6,10),"IT","e002",50000,["b3","b2"])
    ...
    stud1=student("Ruddhi",date(2002,8,13),"Computer","2030331245037",2,9.62)
    stud2=student("Nikita",date(2002,12,22),"Computer","2030331245012",2,9.25)
    stud3=student("Mokshada",date(2002,8,13),"IT","2030331246031",2,8.5)
    stud4=student("Hemangi",date(2002,8,13),"Computer","2030331245020",2,7.1)
    stud5=student("Devayani",date(2002,8,13),"IT","2030331246032",2,4.5)
